...
class Email {
    ...
    private $mail_post = 'adsmanagertest2020@gmail.com';
    private $sitename_short = 'HandFrau';
    private $mail_sender = 'adsmanagertest2020@gmail.com'; // noreply
    private $mail_developer = 'adsmanagertest2020@gmail.com';
    ...
    public  function newLetter($options, $sentRightNow = true) {
        if($options['subject']) {
            ...
            $this->setSubject('Письмо с сайта Prinity.ru');
        }
    ...
    public function addAttachment($filename, $extension) {
        ...
        if (!$this -> attache['body']) {
            ...
            $head .= "X-Mailer: WiseCMS MailSystem\n";
    ...
    private function buildHeaders() {
        ...
        $header .= "X-Mailer: PRINITY MailSystem\r\n";
    ...
    private function getMessageInfo() {
        $info = '<br><br><p>';
        $info .= 'Дата отправки: ' .date('d.m.Y, H:i:s').'<br>';
