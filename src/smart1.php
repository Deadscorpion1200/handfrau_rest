...
$phone = $_POST['orderTel'];
$count = $_POST['orderCount'];
$type = $_POST['orderType'];
$services = $_POST['orderServices'];
...
$mail->Body    = '
	...
	Тип уборки: <strong> ' . $type . '</strong><br>
	Дополнительные услуги: <strong> ' . $services . '</strong><br>
	Стоимость уборки: <strong>' . $count . '</strong><br>';
